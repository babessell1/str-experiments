...
def create_2_plots(WT_df1, WT_df2, slop=1000*5, first="strling", apoe="All APOE", cohort="All Cohorts"):
    ...
    #WT_df1 = WT_df1[WT_df1['variant'] == "GGT"]
   ...
   # WT_df1 = WT_df1[WT_df1['variant'].str.len() > 2]
    ...
    if first == "strling":
        ...
        title1 = "STRling"
        title2 = "ExpansionHunter Denovo"
    else:
        label1 = "ExpansionHunter"
        label2 = "STRling"
        title1 = "ExpansionHunter Denovo"
        title2 = "STRling"
